-- Configuration taken from EdenEast
...
-- file: `lua/user/feline/colors.lua` to see how they are defined.

require("user.feline.colors")
local u = require("user.feline.utils")
...
require("feline").winbar.setup({
	components = { active = winbar_active },
	highlight_reset_triggers = {},
	force_inactive = force_inactive,
	disable = disable,
})
