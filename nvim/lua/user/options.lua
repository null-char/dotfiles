...
-- fixes a weird flickering issue when the same buffer is open in different splits
-- PR which could potentially fix it: https://github.com/neovim/neovim/pull/33145
