...
_G.packer_plugins = {
  ...
  ["close-buffers.nvim"] = {
    loaded = true,
    path = "/Users/null-char/.local/share/nvim/site/pack/packer/start/close-buffers.nvim",
  ...
  ["impatient.nvim"] = {
    loaded = true,
    path = "/Users/null-char/.local/share/nvim/site/pack/packer/start/impatient.nvim",
